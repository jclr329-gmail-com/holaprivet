@extends('layout')
@section('titulo', 'Стена слов: поддержать бесплатный курс')
@section('descripcion', 'Курс бесплатный, а стена — то, что его держит. Возьмите слово из курса под опеку на год, и оно будет носить ваше имя, пока курс бесплатен для всех.')
